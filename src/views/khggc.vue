      ...
      <el-main class="main">
            ...
            <el-dropdown trigger="click">
              <el-popover placement="bottom" width="350" trigger="click">
                <el-tabs
                  ...
                  style="height: 188px; width: 350px"
                >
                  <el-tab-pane label="常用检索" class="span">
                    <span>我领取的</span><br />
                    <span>部门领取的</span><br />
                    <span>今日归还的</span>
                  </el-tab-pane>
        ...
        <div>
          ...
          >
            ...
            <el-table-column prop="name" label="行业" width="150">
            </el-table-column>
            <el-table-column prop="name" label="来源" width="150">
            </el-table-column>
            <el-table-column prop="type" label="客户类型" width="100">
            </el-table-column>
            <el-table-column prop="state" label="销售阶段" width="120">
            </el-table-column>
            <!-- <el-table-column prop="person" label="联系人" width="60">
            </el-table-column>  -->
            <el-table-column prop="phone" label="电话" width="110">
            </el-table-column>
            <!-- <el-table-column prop="reason" label="入池原因" width="170">
            </el-table-column>  -->
            <el-table-column prop="time" label="创建时间" width="130">
            </el-table-column>
          ...
          <div class="main3">
            显示12条客户信息 &nbsp;&nbsp;&nbsp; 总共66666条客户信息
            &nbsp;&nbsp;&nbsp;
            <i class="el-icon-setting"></i> 每页显示 <span> 12条 </span
...
export default {
  ...
  created() {
    this.axios
      .get("http://yapi.dapengjiaoyu.com/mock/380/order")
      .then((msg) => {
